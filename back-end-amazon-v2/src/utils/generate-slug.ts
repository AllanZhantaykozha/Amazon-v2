const translit = (str: string): string => {
	...
	const en =
		'A-a-B-b-V-v-G-g-G-g-D-d-E-e-E-e-E-e-ZH-zh-Z-z-1-1-1-1-I -i-D-j-K-k-L-1-M-m-N-n-O-o-P-p-R--S-s-T-t-U-u-F-f-H-h-T S-ts-CH-ch-SH-sh-SCH-sch-"--Y-y-"--E-e-YU-yu-YA-ya'.split(
			'-'
		)
